...
label Day5_Rumi:
    ...
    pg scared "You are both making us look like complete idiots!"
    show pg think

    r "I am making us look like idiots?! Look at this dickhead who is making me look like one alre-"

    pg scared "Don't you think I've told him how absolutely stupid he is already for doing this?!"
    pg "Do you really think telling him to go fuck himself is going to change anything?!"
    show pg think

    r "Wh- Why are you talking back to me?!"
    show mc 2 laugh
    "This guy was just grinning because Angela of all fucking people dared to talk to me like a superior or something."

    think "I swear, when we swap back..."
    show mc 2 happy

    pg scared "Can you guys just, for once, not argue in front of each other?"
    show pg think
    ...
    pg happy "Good! Then we're all going to our classes. Alright?"

    r "...Alright, fine."

    mc "Sure."

    "I felt a bit calmer now, maybe Angela talking back turned out to be the best for me."
    ...
    pg scared "Really, do you think it's a good idea to do anything...?"
    ...
    pg scared "I guess as long as we keep an eye on him to make sure he doesn't do something stupid..."
    show pg think
    ...
    "But things were different now. David was wearing my face and the only help I had was Corny."

    "And, well, Rick, who was currently somehow reading something on his phone while also eating lunch."

    pg scared "Well, got anything in mind?"
    show pg think
    ...
    pg scared "You want to neuter yourself...? While in his body?"
    show pg think
    ...
    pg happy "Ah, so that's what you want to do."
    ...
    pg laugh "We have the greatest weapon right here!"
    ...
    weeb laugh "Act around girls? Could it perhaps be that you want to entrap the heart of a woman just like I do?"
    show weeb happy

    r "Uh... Yeah, whatever you just said."

    weeb think "Oh no. Could it be that you truly are lesbian?"

    r "Wha- No! I just need to give David some payback by having all girls see him like they see you, you kno-"

    pg "Hey, don't tell him the plan! He sides with him after all!"

    weeb laugh "Ah, you want to pay back David's misdoings against you by making him a favor? How wholehearted of you."
    show weeb happy

    r "...Yeah, that."

    weeb laugh "Could this perhaps be a part of my training then?"
    show weeb happy
    ...
    "She sure had a mind of her own now that she was spending time with David, huh?"

    pg laugh "But honestly, you must have done something crazy to him. I know you're a guy for the time being, but he is like, not even paying attention to me."
    ...
    weeb think "What do you mean?"

    r "She means that it's weird that you're not trying to get into her pants."

    pg scared "H- Hey! Don't even try to make me imagine that picture in my head!"
    show pg happy
    ...
    weeb laugh "Strike three: Too short. Although it is important that the height does not exceed the Rick, the girl must be at least able to see above high quality kitchen counters."

    "Angela had a face of absolute terror on her. There was no stopping this, the number one perv of the school was saying that she, of all people, wasn't good enough for him."

    weeb "Strike four: The examinee is not in the least attracti-"

    pg scared "{b}STOP! OH MY GOD, STOP!{/b}"
    show pg think

    weeb think "Huh? What's wrong?"

    pg scared "What's wrong?! Are you kidding me?! You've been hitting on me {i}EVERY TIME{/i} I see you, and now you're telling me I'm ugly!"
    show pg think

    r "-ahahah, yeah, that's kinda true, actually..."

    weeb laugh "Of course I would, you were with the lovely Rumi after all."
    show weeb happy

    pg scared "...Wait, so you're saying that every time you were hitting on us, you were only hitting on Rumi?"
    show pg think

    weeb laugh "Of course. Wasn't that clear?"
    show weeb happy
    ...
    pg scared "I absolutely {i}refuse{/i} to accept that you, of all people, are telling me that!"

    pg "You don't realize there is a charm to smaller girls?!"
    show pg think

    weeb think "Charm? There is no charm about that. There needs to be something else, and I do not see that in you."

    pg scared "Wha- Why- You..."
    show pg think
    show weeb happy

    r "-ahahah, this is killing me..."

    pg scared "He- Hey, stop l- Laughing!"
    show pg think

    "Rick's confused look just made this so much better, but knowing that lunchtime wouldn't last forever, I finally managed to get a grip on myself again."
    ...
    weeb laugh "{i}So, first of all, you must find your target. Ideally, try to approach her in seclusion.{/i}"
    show weeb happy

    r "{i}Seclusion...? Really?{/i}"

    weeb laugh "{i}Anything wrong?{/i}"
    show weeb happy

    r "{i}It just sounds so fucking creepy when you say it like that.{/i}"

    weeb laugh "{i}Uh, well... Approach her while she is alone, then?{/i}"
    show weeb happy
    ...
    weeb laugh "{i}First of all, declare that your heart is hers!{/i}"
    show weeb happy

    scene black

    "Heh, the plan was simple. Go and ask loads of girls out and get rejected in order to start rumors of David confessing to {i}everyone{/i}."
    ...
    think "Alright, Rick-gameface on."
    ...
    think "Guess Rick's moves really do completely alienate every girl he talks to."
    ...
    weeb laugh "{i}Most importantly, convey your feelings in a most romantic way.{/i}"
    ...
    weeb think "{i}We- Well, you did mention that my strategy was ineffective...{/i}"
    ...
    think "Yeah, that's it. They are crazy to actually accept a confession from someone like David."

    "Now, to the main dish. Anna."
    ...
    think "Also, no more Rick talk! I'm doing this my own way now."
    ...
    "Without really being able to retaliate, I ended up adding her number, which I already knew, to David's phone."
