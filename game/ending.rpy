...
label Year9_Day1_MC:
    ...
    "Despite the lack of results, Rick had actually impressed me at the stuff he could come up with."
    "Like really, I think at some point we ended up catching a fly, cooking it, splitting it in two, and had both me and David eat one half."
    ...
    "Oh, and me and David now refer to each other by our body name, even while alone. It just makes more sense that way."
    ...
    "I knew that Angela would appear because I promised her to take home her package-"
    ...
    pg think "Did my parcel arrive?"

    mc "Yeah yeah. Come on in."

    scene bg room_dusk_light with fade
    ...
    pg think "You mentioned that before. You sure it doesn't get a bit lonely as the only girl in your department?"
    ...
    pg happy "Finally, I've been waiting to get my hands on this."
    ...
    pg think "But, uh... Are you not going to be under stress if you still want to dress and all that? I already took a shower at uni, but if we want to make it in time, we need to be on the road in thirty minutes."
    ...
    pg laugh "Haha, you really didn't notice?"
    ...
    scene bg bighouse with wipeleft
    ...
    pg happy "I'm not addicted! I just like it."
    ...
    scene bg bighouse_dining with fade
    ...
    show rumi think at two_left with dissolve
    show weeb think at two_right with dissolve

    "Eventually, I spotted David and Rick talking to each other."

    r "-No, look, I'm not going to raise it."

    r "Why do you even want one to begin with?"

    r happy "Oh, hey girls."
    ...
    show pg happy at three_left with easeinleft

    pg "Hey."

    mc "Whazzup."

    r think "Drop the attempt at being hip with the times already. Seriously."
    ...
    r happy "It sounds more insane if he explains it."

    r "So go right ahead, what were we talking about?"

    weeb think "I cannot really see the \"insane\" in it."

    weeb "I just wanted David to raise a guard dog for us."

    weeb happy "I believed it was well within his power to do so since he works with animals on a daily basis."

    r think "The entire point of a guard dog is for the guard dog to actually {i}guard you{/i}, you moron."

    r "If I were to raise it then it wouldn't see you as it's master, which totally defeats the entire point of a guard dog."

    pg think "Uh, honey, a dog?"

    weeb think "Of course. I thought, on days where you were off, you might feel less lonely with a companion around when I am not home."

    pg happy "Aw. That's kind of sweet, isn't it?"
    ...
    weeb happy "Is that a new outfit you're wearing?"

    pg "Oh? Y- Yeah, I hope you like it..."

    weeb "You look stunning."

    "His praise was apparently something that got Angela completely addicted."
    ...
    "While he was mumbling something to her which I didn't quite catch, me and David both just sighed."
    "It was a pretty common occurrence for Angela to seek praise from this guy, enough to make us both think she has a bit of a problem."
    ...
    scene bg bighouse_table with fade

    "My inner thoughts were swiftly interrupted though when David nudged me, demanding my attention."
    ...
    r happy "{size=-5}If you get the chance, you should ask her where she got it from.{/size}"

    mc "{size=-5}{i}Sigh...{/i} I already have enough \"party-wear\". I'm not rich, you know.{/size}"

    r think "{size=-5}At least ask her for reference then.{/size}"
    ...
    "Since Angela was driving, I thought I might as well have some."

    show rumi at two_left with ease
    show Waitress at two_right with dissolve

    waitress "Would you like a glass?"

    r happy "Yes. Red wine."
    ...
    r cry "I kind of pity you for not even being able to stomach just one burger, heh."

    "I just rolled my eyes at her usual flaunting."

    "The waitress looked a bit confused at what David said though."
    ...
    r happy "About that girl? Who cares, not like I'm ever going to meet her again."
    ...
    show Waitress at three_right
    with dissolve

    #scene restaurant, PG and Weeb
    waitress "Uhm... Excuse me?"
    weeb think "Hm? What is it?"

    waitress "Could I ask about the two you were talking about? Rumi and David are their names? The gray haired man and the pink haired woman."
    pg think "Uh, yeah. What about them?"
    ...
    pg laugh "Pffahaha, those two?"

    pg happy "Hell no. They barely even get along most of the time."

    weeb happy "Yup."

    weeb "But they do share a special bond that goes beyond what most people share."

    pg think "A special bond? That's a really poetic way of explaining it."

    pg happy "But yeah, can't say much more than that they are a special case."
    ...
    weeb think "{size=-5}Hey Angela. She sounds suspicious.{/size}"

    pg scared"{size=-5}Of course she does you dum-dum.{/size}"

    waitress "I'm terribly sorry for bothering you! I have to get back to the bar now, thank you for talking to me."

    show pg happy

    weeb happy "Our pleasure."
    ...
    r think "Fair enough. Just thought I'd mention it."
    ...
    scene bg bighouse_lib with wipeleft

    show rumi think at two_right with dissolve
    ...
    show Waitress at two_left with dissolve

    waitress "Ah! I'm sorry! I shouldn't have spied on you!"

    "David just looked at me as if expecting me to know what to do in this situation."

    "I just shrugged while telling him \"You dragged me into this, handle it yourself!\" in body language."

    r scared "You were spying on us?"
    ...
    r think "If you're going to ask us something then do it now. Do you want to know how the food was or something?"
    ...
    r think "That is a question that could mean a lot of things, so specify."

    mc "What? David, she is asking us if-"
    ...
    think "But with me and David, it's only two who were swapped."
    think "And how does someone even swap bodies with... Nobody else?"

    think "Or is she telling me that David wasn't originally Rumi...?"
    think "Yeah, no way that can be true."

    "It was clear that he was confused too, but he still had a more relaxed expression now."

    r think "And by help, you mean...?"

    waitress "{i}Sigh...{/i} We give people the opportunity to undo it. I don't know how else to be less specific."

    r happy "...In that case, yes, we are likely to be part of that group of people you're looking for."

    waitress "Really?!"

    waitress "Yes!"

    r think "You're talking about people that had their personalities switched, correct?"
    ...
    r scared "What the hell is this? Do you seriously think we'd believe that?"
    ...
    r think "The hell do you mean \"fly\"? It's a trick! Don't tell me you actually think this is real."
    ...
    waitressJ "Josephine, 9th generation messenger angel of the high heavens."
    ...
    mc "David, we both had our bodies swapped. Angels being real is a very minor side-dish to that fact."
    r think "..."
    ...
    waitressJ "Yes, yes. It takes a bit of time since it's new technology, even for us, but we've helped a lot of people already!"

    r happy "So we just go back to their normal lives and pretend as if nothing had happened?"

    waitressJ "Exactly! We have the power to make it a seamless process. You won't even know you swapped if you would like that."

    r think "...Hm, I don't know..."

    mc "I'm in the same boat, this sounds a little... You know..."

    waitressJ "Fishy? We can let you talk with people who we've helped before if you don't trust us, so you don't have to worry about user reviews!"
    ...
    waitressJ "Huh? You don't want to go back?"

    waitressJ "How did you guys even meet in the first place?"
    mc "...School?"

    r happy "High school."
    waitressJ "Oh, wow. You both went to school together and were swapped?"

    waitressJ "You guys are lucky."

    waitressJ "I guess that's why you're okay with it then."

    r think "How is this lucky? We worked hard towards the outcome together."
    r "If anything we were lucky to turn this mess of ours into something positive."

    mc "Agreed."

    waitressJ "Uh... To each their own I suppose."

    waitressJ "But you are certain you don't want to go back to your original bodies then?"

    r happy "Of course. We've already talked about this."
    ...
    waitressJ "Ah. I see. Then this has also managed to make some people happy. That is a relief."

    pg "{size=-5}Rumi?! David?! Are you guys out here?!{/size}"
    think "Ah, they must be long done saying their farewells inside by now."

    waitressJ "Oh, and uh, don't tell anyone else I exist, please. I think my boss doesn't want everyone to know that I'm an angel and everything... You know."

    r "We've been keeping a bigger secret like that throughout half our lives. Our lips are sealed."

    waitressJ "Thank you so much."

    waitressJ "In the name of Nero the Holy, I wish you both farewell and the best."
    waitressJ "And if you ever meet a being called Joseph, please make sure to greet him for me."

    hide Waitress with dissolve
    show rumi at one

    "With that, she was gone."
    r think "She dead-ass just flew away. Wow."
    ...
    #show PG
    show rumi at two_right with ease
    show pg happy at two_left with easeinleft
    ...
    pg think "I was almost worried you both decided to walk home from here."

    r think "We're not {b}that{/b} drunk."
...
label Year9_Day2_MC:
    ...
    pg happy "There's husky, border co-"

    mc "You already got it."

    pg laugh "Hah, really? Was it husky?"

    mc "Yeah..."

    show pg happy

    "We were playing a new game Angela had bought right now."
    ...
    "Angela and Rick had a husky at home, so obviously this one was way easy for her to guess in this case."
    ...
    pg think "Has life been treating you well recently?"
    ...
    pg think "But you managed to avoid being part of that crunching thing again?"
    ...
    pg happy "I wouldn't mind spending a dollar or twenty on it."
    ...
    r think "Argh, no, I just managed to get them tangled around my leg."

    r happy "Oh, and, hey."

    mc "Anything exciting happened? Since you took the trip here without announcing it."

    r "Angela is here too?"
    ...
    r think "Hey! Sorry for interrupting what you were doing!"
    ...
    r "Rick phoned me about it. He tried texting you too but you hadn't responded yet."
    mc "My phone is charging in my bedroom, so that's why."

    r "It's the headline today."

    r think "No, wait, let's go into the living room before you read it."
    ...
    "While David was making room, seemingly to give space for the newspaper, Angela had a curious look."

    pg think "Something happened?"
    ...
    think "\"Sandra Bloom (28) describes her recent years of panic and anxiety, as she believes herself to be born as someone else entirely.\""
    think "\"In her past, she claims to have been Zendaya Uduike, and despite never having shown interest in African culture, manages to speak fluent Swahli and knows many other customs and locations.\""
    think "\"Her story is chilling, to the point where one could wonder if there is a grain of truth in it.\""

    scene bg room_noon with fade

    "Angela was done reading before I was, so when I looked up, she had already recoiled."
    ...
    r think "Jesus... I feel kinda bad for making fun of her now..."
    ...
    r happy "Even if it was you, I can't imagine how screwed my life would be if I swapped with someone across the globe, assuming what happened to her was the exact same as what happened to us..."

    r "Especially from a dump like Africa."

    pg think "But what happened to the real Sandra then?"

    mc "I was wondering that too."

    r think "Right... About that."
    ...
    "Angela gasped and put her hands around her mouth."
    ...
    r happy "I thought back to those words too. That girl we met must have known about Sandra."
    ...
    r think "Exactly. In just our little city, three people had this happen to them. Imagine how many people this has happened to worldwide!"
    ...
    pg scared "Wh- Who is \"that girl\"?"

    r "Uh... Can't say, sorry."

    "Angela raised a brow, but didn't look further into it."
    show pg think

    r happy "But really, it does make me curious. What on earth really happened back then to cause all of this..."
