...
label Day17_MC:
    ...
    kat "David has been doing some screwed up stuff lately, you know that, right?"

    kat "Stuff that I know he wouldn't have done."

    kat "I know that he liked his hair the way it was, and that he never really was into all of that love-life crap."
    kat "So to see him suddenly \"confess\" to Emily and that new girl on the same day makes me incredibly sus."
    ...
    kat "Just... How did this happen then? Rick has been spamming us with texts about what he is doing and what happened, but..."
    ...
    "Their background was still a mystery to me since they seemed to be close as kids, but Angela said I was better off not knowing about this."
    ...
    kat "I would very much mind."

    mc "...Uhm... Why?"

    kat "Because, Rumi. That's why."

    kat "-I -I mean, David. Sorry."
    ...
    kat "It's, uh... It's because of Sandra..."
    ...
    kat "...One day when she woke up, Anuja found her rolling on the ground with her entire room completely destroyed."
    ...
    kat "It was so bad that her fingernails were almost entirely ripped off, and... There was blood everywhere on her hands and face when they found her..."

    mc "...Holy shit..."

    kat "I've heard about it from Anuja and Sandra's parents. Anuja said that when she first saw Sandra like that, Sandra was mumbling as if talking another language entirely..."
    kat "It freaked Anuja completely to the point where she now has nightmares about it..."
    ...
    mc "Besides, the people we've told were all really skeptical about it as well, except for Rick."
    ...
    kat "I'm sorry, I just can't..."

    kat "You look exactly like her, sound like her, smell like her..."

    kat "{size=-5}...The guy I liked more than anything turned into the girl I hate more than anything...{/size}"
    ...
    kat "We are still friends, but..."

    kat "I wanted to tell you that. It's selfish of me to say this, but when you go back to being yourself, please tell me as soon as possible."

    kat "But until then, I..."
    "..."
    mc "Oh..."
    ...
    $renpy.pause(1)
    hide Katrina with moveoutright
    ...
    caren "Rick has been texting us a lot about finding a solution to revert this swap of personality that you and Rumi have experienced, and I'll try giving it a shot to figure out what happened as well."
    ...
    think "Well, Rick does as well, but his methods are a bit more unorthodox."
